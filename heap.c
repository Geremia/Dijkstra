...
*****************************************************************************/
    ...
    if ((temp = (struct node **)realloc(heap->tree, (heap_size(heap) + 1) * sizeof
                                        (struct node *))) == NULL) {
...
*****************************************************************************/
    ...
    ((struct node *)data)->ipos = heap_size(heap);
    heap->tree[heap_size(heap)] = (struct node *)data;
 ...
 ***********************************************************************/
            ...
            ((struct node *)(heap->tree[mpos]))->ipos = ipos;
            heap->tree[ipos] = temp;
            ((struct node *)(heap->tree[ipos]))->ipos = mpos;
